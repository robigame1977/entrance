  ...
  return (
    ...
    <Card className="card">
      <CardHeader className="card_header">
        <CardTitle className="card_h1">Hey there!</CardTitle>
      ...
      <CardContent className="card_p">
        <p>You are required to log in before accessing this resource. Please log in using the first button below. If you had already tried to log in, please use the second button instead.</p>
        <div className="buttons">
          <Button variant="outline" className="login_btn" asChild><Link href={discord_url}>Login with Discord</Link></Button>
          <Button variant="outline" className="req_btn"><Link href="/request">Request an access</Link></Button>
        </div>
      </CardContent>
